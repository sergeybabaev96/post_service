...
public class AnalyticsEventFromDateFilterTest {
    private final AnalyticsEventFromDateFilter filter = new AnalyticsEventFromDateFilter();
    ...
    public void givenFilterDto_whenApply_thenReturnResult() {
        ...
        Stream<AnalyticsEvent> stream = Stream.of(
                ...
                AnalyticsEvent.builder()
                        ...
                        .receiverId(1L)
                        .eventType(EventType.COMMENT_ADD)
                        .createdAt(createdAt.minusHours(14))
                        .build()
        );
